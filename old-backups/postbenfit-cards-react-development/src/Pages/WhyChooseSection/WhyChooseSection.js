                ...
                <article className="container px-4 mx-auto">
                    <ul className="flex flex-col items-start justify-center gap-6 lg:gap-0 sm:gap-6 md:flex-row md:gap-6">
                        ...
                        <li className="flex items-start gap-1">
                            <span className="flex items-center text-6xl font-bold 
                            justify-cente text-pink-200">
                                1
                            </span>
                            <div>
                        ...
                        <li className="flex items-start gap-0">
                            <span className="flex items-center text-6xl font-bold justify-cente
                             text-pink-200">
                                2
                            </span>
                            <div>
                        ...
                        <li className="flex items-start gap-0">
                            <p className="flex items-center mb-1 text-6xl font-bold
                             justify-cente text-pink-200"> 3
                            </p>
                            <div>
                                ...
                                <p className="text-xs text-gray-600">
                                    ...
                                    underline ms-2 hover:text-pink-700 duration-500 transition-all ease-in-out">Read the fine print.</a>
                                </p>
                            </div>
                        </li>
                    </ul>
